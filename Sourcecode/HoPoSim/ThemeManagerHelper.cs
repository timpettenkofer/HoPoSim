...
namespace MahAppsMetroThemesSample
{
    public static class ThemeManagerHelper
    {
        ...
        {
            HoPoSim.Properties.Settings.Default[ApplicationSettingNames.UITheme] = name;
            HoPoSim.Properties.Settings.Default.Save();
        }

        public static void RestoreTheme()
        {
            var uiTheme = ThemeManager.GetAppTheme((string)HoPoSim.Properties.Settings.Default[ApplicationSettingNames.UITheme]);
            var theme = ThemeManager.DetectAppStyle(System.Windows.Application.Current);
            ThemeManager.ChangeAppStyle(System.Windows.Application.Current, theme.Item2, uiTheme);
        }

        public static void SaveAccent(string name)
        {
            HoPoSim.Properties.Settings.Default[ApplicationSettingNames.UIColor] = name;
            HoPoSim.Properties.Settings.Default.Save();
        }
        ...
        {
            var theme = ThemeManager.DetectAppStyle(System.Windows.Application.Current);
            var uicolor = GetColor((string)HoPoSim.Properties.Settings.Default[ApplicationSettingNames.UIColor]);
            CreateAppStyleBy(uicolor, true);
        }
        ...
        private static Color GetColor(string name)
        {
            ...
            return color != null ? (Color)color.GetValue(null) : Colors.ForestGreen;
        }
    }
}